...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "eFranc " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"efranctools.com", "84.200.101.138"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"efranctools.com", "testnet-seed.efranctools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. eFranc is probably already running."), addrBind.ToString().c_str());
        else
